...
Meteor.methods({
    ...
    deleteCategory: function (categoryId) {
        ...
        if (hasParent(category)) {
            var parentCategory = BudgetCategory.findOne({
    ...
    deleteBudget: function (budgetName) {
        ...
        var budgetCategories = Budget.find({
    ...
    deleteTransaction: function (transactionId) {
        checkUserValid();
        var transaction = Transaction.findOne({_id: transactionId, owner: Meteor.userId()});
        if (!transaction) {
